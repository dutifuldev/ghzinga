...
3. The tmux mouse-smoke captures send xterm SGR mouse click sequences and plain
   ...
   fixture mode, Activity `[details]` exact permalink opening for both PR and
   issue resources, footer copy/open first-visible-URL routing through
   ...
   persistence into capture-local TOML, and footer quit clicks that exit the
   tmux sessions.
