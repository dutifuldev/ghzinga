---
title: ghzoom Timeline Schema Coverage Plan
author: Bob <dutifulbob@gmail.com>
date: 2026-05-31
---

# ghzoom Timeline Schema Coverage Plan

This plan closes another gap between ghzoom's chronological Activity view and
...
ghzoom already fetches and renders the high-signal issue and PR lifecycle
...
`PULL_REQUEST_COMMIT`, `PULL_REQUEST_REVIEW`, and review-thread objects. ghzoom
...
- Avoid requiring project title fields in the core timeline query. Project
  metadata can require broader `read:project` scope; ghzoom already handles
